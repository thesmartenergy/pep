...
public class ProcedureExecutionContainer {
    ...
    public ProcedureExecutionContainer(ProcedureExecutor procedureExecutor, String containerPath, String inputGraphURI, String outputGraphURI) {
